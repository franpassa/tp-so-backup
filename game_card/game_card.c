...
/*
	...
	new_pokemon_msg* msg_recibido = (new_pokemon_msg*) recibir_mensaje(NEW_POKEMON,&id_recibido);
	...
	new_pokemon_msg* msg_recibido2 = (new_pokemon_msg*) recibir_mensaje(NEW_POKEMON,&id_recibido2);
